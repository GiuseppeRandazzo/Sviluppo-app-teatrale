    ...
    <nav className="bg-white shadow-sm">
        ...
        <div className="flex justify-between h-16">
          <div className="flex">
            ...
            <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
              ...
              <Link
                to="/dashboard"
                className={`inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium ${isActive('/dashboard') ? 'border-primary-500 text-gray-900' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700'}`}
              >
                I miei progetti
              </Link>
            </div>
      ...
      <div className="sm:hidden hidden">
        <div className="pt-2 pb-3 space-y-1">
          ...
          <Link
            to="/dashboard"
            className={`block pl-3 pr-4 py-2 border-l-4 text-base font-medium ${isActive('/dashboard') ? 'bg-primary-50 border-primary-500 text-primary-700' : 'border-transparent text-gray-600 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-800'}`}
          >
            I miei progetti
          </Link>
        </div>
          ...
          <div className="flex items-center px-4">
            {isAuthenticated ? (
              <div className="w-full space-y-2">
                <span className="block text-gray-700 text-center">{user.name}</span>
                <button 
              ...
              <Link to="/auth" className="block text-center w-full px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-primary-600 hover:bg-primary-700">
                Accedi
              </Link>
            )}
          </div>
