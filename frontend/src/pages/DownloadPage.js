...
const DownloadPage = () => {
  ...
  const handleDownload = async () => {
    try {
      ...
      // In una vera implementazione, qui ci sarebbe il download del file
      alert(
        `Download del video in formato ${downloadFormat.toUpperCase()} con qualità ${quality} completato!\n\nIl file verrà salvato nella cartella Download.`
      );
    } catch (err) {
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                ...
                <span className="font-medium">
                  {project.metadata?.title || "Senza titolo"}
                </span>
              </div>
      ...
      <div className="mt-12">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="card p-6 text-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-8 w-8 mx-auto mb-4 text-gray-500"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor">
              <path
            ...
            <p className="text-sm text-gray-600 mb-4">
              Ottieni solo le tracce audio dei dialoghi
            </p>
          ...
          <div className="card p-6 text-center">
            ...
            <p className="text-sm text-gray-600 mb-4">
              Scarica le immagini chiave delle scene
            </p>
            <button className="btn-secondary w-full py-2 text-sm">
              Scarica ZIP
            </button>
