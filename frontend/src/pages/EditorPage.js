...
const EditorPage = () => {
  ...
  useEffect(() => {
    const fetchScript = async () => {
      try {
        // Carica dati mock da localStorage
        ...
        if (stored) {
          ...
          const mockScript = {
            ...
            metadata: {
              ...
              description: "Un esempio di copione teatrale",
              genre: "drama",
            },
            characters: [
              { name: "ROMEO", gender: "male", dialogues_count: 45 },
              { name: "GIULIETTA", gender: "female", dialogues_count: 38 },
              { name: "MERCUZIO", gender: "male", dialogues_count: 22 },
            ],
            acts: [
              {
                number: 1,
                scenes: [
                  {
                    number: 1,
                    setting: "Una piazza a Verona",
                    description:
                      "Romeo e Giulietta si incontrano per la prima volta",
                    dialogues: [
                      {
                        character: "ROMEO",
                        text: "Ma quale luce sorge da quella finestra?",
                        type: "dialogue",
                      },
                      {
                        character: "GIULIETTA",
                        text: "Romeo, Romeo, perché sei tu Romeo?",
                        type: "dialogue",
                      },
                    ],
                  },
    ...
    <div className="py-8 px-4 max-w-7xl mx-auto">
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-2xl font-bold">
          {script.metadata?.title || "Copione senza titolo"}
        </h1>
        <div className="flex space-x-4">
          ...
          <button
            ...
            className={`btn-primary py-2 px-4 flex items-center ${
              generating || !script.audio_generated
          ...
          <div>
            ...
            <div className="mb-4 p-3 bg-blue-50 rounded-lg border border-blue-100 text-sm text-blue-800">
              <p>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-5 w-5 inline mr-1 text-blue-600"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor">
                  <path
                ...
                Sono stati rilevati{" "}
                <strong>{script.characters?.length || 0} personaggi</strong> nel
                copione. Puoi personalizzare le voci e gli avatar per ciascun
                personaggio.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {script.characters?.map((character, index) => (
                <div
                  key={index}
                  className="card p-4 border border-gray-200 hover:border-primary-300 transition-colors">
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <div
                      className={`rounded-full w-12 h-12 flex items-center justify-center text-white font-medium ${
                        character.gender === "male"
                          ? "bg-blue-500"
                          : character.gender === "female"
                          ? "bg-pink-500"
                  ...
                  <div>
                    ...
                    <select className="input w-full" defaultValue="default">
          ...
          <div>
            ...
            <div className="mb-6 p-3 bg-blue-50 rounded-lg border border-blue-100 text-sm text-blue-800">
              <p>
                ...
                Sono stati rilevati{" "}
                <strong>{script.acts?.length || 0} atti</strong> e{" "}
                <strong>
                  {script.acts?.reduce(
                    (total, act) => total + (act.scenes?.length || 0),
                    0
                  ) || 0}{" "}
                  scene
                </strong>{" "}
                nel copione. Puoi personalizzare le ambientazioni e lo stile
                visivo per ciascuna scena.
              </p>
            </div>
              ...
              {script.acts?.map((act, actIndex) => (
                <div key={actIndex} className="mb-8">
                  ...
                  {act.scenes?.map((scene, sceneIndex) => (
                    <div
                      key={sceneIndex}
                      className="card p-4 mb-4 border border-gray-200 hover:border-primary-300 transition-colors">
                      <div className="flex justify-between items-center mb-4">
                        <div>
                          <h4 className="font-medium">Scena {scene.number}</h4>
                          <div className="text-sm text-gray-500">
                            {scene.dialogues?.length || 0} battute •{" "}
                            {scene.setting
                              ? `Ambientazione: ${scene.setting}`
                              : "Nessuna ambientazione specificata"}
                          </div>
                        </div>
                        <div className="flex space-x-2">
                        ...
                        <div className="mb-4 border-l-2 border-gray-200 pl-3">
                          ...
                          {scene.dialogues.length > 2 && (
                            <p className="text-xs text-gray-500">
                              + altri {scene.dialogues.length - 2} dialoghi
                            </p>
                          )}
                        </div>
                      )}
          ...
          <div>
            ...
            <div className="mb-6 p-3 bg-blue-50 rounded-lg border border-blue-100 text-sm text-blue-800">
              <p>
                ...
                Configura le impostazioni generali del progetto e i servizi di
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                ...
                <div className="mb-4">
                  ...
                  <select className="input w-full" defaultValue="elevenlabs">
                ...
                <div className="mb-4">
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                    Servizio di generazione video
                  </label>
                  <select className="input w-full" defaultValue="pikalabs">
                ...
                <div className="mb-4">
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Una qualità più alta richiede più tempo di elaborazione
                  </p>
                </div>
                ...
                <div className="mb-4">
                  ...
                  <select className="input w-full" defaultValue="mp4">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <span className="ml-2 text-sm font-medium">
              {script.video_generated
                ? "Video generato"
                : script.audio_generated
                ? "Audio generato"
                : "Analisi completata"}
            </span>
          </div>
          ...
          <div className="flex items-center">
            ...
            <div className="w-48 bg-gray-200 rounded-full h-2.5">
              <div
                ...
                style={{ width: `${script.progress || 0}%` }}></div>
            </div>
            <span className="ml-2 text-sm text-gray-500">
              {script.progress || 0}%
            </span>
